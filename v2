...
st.set_page_config(page_title="NAPS Tools", layout="centered", initial_sidebar_state="collapsed")
    ...
    React.createElement('path', {
        ...
        function OneRMCalculator() {
            ...
            const calculate1RM = () => {
                ...
                if (exerciseType === 'weights') {
                    ...
                    oneRM = (0.9348 * bw + w) * (1 + (r / 30));
                } else if (exerciseType === 'pushups') {
                    oneRM = (0.75 * bw + w) * (1 + (r / 30));
                }
            ...
            return React.createElement('div', { className: 'max-w-md mx-auto p-4 pb-20' },
                ...
                React.createElement('div', { className: 'mb-6' },
                    ...
                    // PDC (only show for bodyweight and pushups)
                ...
                oneRM > 0 && React.createElement('div', { className: 'mb-6' },
                    ...
                    React.createElement('div', { className: 'grid grid-cols-2 gap-2' },
                        percentages.map(pct => 
                            React.createElement('div', { 
                                key: pct,
                                className: 'p-4 bg-white rounded-2xl border border-white shadow-sm'
                            },
        ...
        function App() {
            ...
            return React.createElement('div', { className: 'min-h-screen' },
                ...
                currentTool === 'checklist' 
                    ? React.createElement(ChecklistApp)
                    : React.createElement(OneRMCalculator)
            );
        }
